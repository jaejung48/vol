...
while True:  
    ...
    ######################################################################### 
        if nlt == 1 and mid_m30_197 * 2 < up_m30_197 and l_m30_197 < l_m30_198 :
            bot.sendMessage(chat_id = tlgm_id, text = ticker+'첫번째')
            if o_m30_197 < c_m30_197 and h_m30_197 < c_m30_198 :
                bot.sendMessage(chat_id = tlgm_id, text = ticker+'두번째')
                if h_m30_198 < bu20_m30_198 :
