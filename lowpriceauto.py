...
total_weight = krw_balance  # 투자금액 설정
...
while True:  
    ...
    for ticker in tickers :
        ...
        m5_low_190_198 = l_m5.iloc[190:198]
        m5_min_low_190_199 = m5_low_190_199.min(axis = 0)
        m5_min_low_190_198 = m5_low_190_198.min(axis = 0)
    ...
    if m5_min_low_190_199 < bd20_m5_199 : 
    ...
    ######################################################################### 
        if ma5_m5[199] > ma5_m5[198] and m5_min_low_190_198 <= m5_min_low_190_199 :
            if m5_min_low_190_199 < bd20_m5_199 :
                if (h_m5[198] - current_price)/h_m5[198] < 0.03 : 
    ...
    #########################################################################          
        if current_price < m5_min_low_190_199 :
